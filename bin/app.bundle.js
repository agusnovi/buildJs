...
var _cast = __webpack_require__(327);
...
try {
    for (var _iterator = _cast2.default[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var cat = _step.value;
